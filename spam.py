...
try:
    versi='1.1'
    requp=requests.get('https://raw.githubusercontent.com/XiuzSec/spam/master/README.md').text
    if versi in str(requp):
        up=r+r+'['+G+'INFO'+r+'] Type ['+G+'99'+r+'] to update '
        update= r+'['+C+now("%X")+r+'] Updating spam tools...'
...
print("""
        ...
        {}|::.. . |{}    |::.. . |      {}Version {}:{} 1.0
        {}`-------'{}    `-------'
      +________________________{}XiuzSec{}_________________________+
        """.format(R,r,R,r,R,r,R,r,R,r,G,r,G,R,r,G,r,G,R,r,G,r))
...
if no =='':
    ...
    try:
        ...
        os.system('cd ..;git clone https://github.com/XiuzSec/spam > /dev/null 2>&1')
